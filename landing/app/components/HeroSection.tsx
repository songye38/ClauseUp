...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Logo / Title */}
      <h1 className="mb-8 font-aleo text-[60px] font-black">
        ClauseUp
      </h1>

      {/* Headline */}
      <p className="mb-10 text-center font-sandoll text-[36.75px] leading-[49.5px]">
        디자인은 늘 수정하는데<br />
        계약은 수정없이 사인하셨나요?
      </p>

      {/* Subcopy */}
      <p className="text-center text-[25px] font-bold leading-[34px]">
        ClauseUp은<br />
        디자이너가 묻지 못했던<br />
        기준을 대신 정리합니다.
      </p>
